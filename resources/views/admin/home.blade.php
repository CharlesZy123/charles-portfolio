...
@section('content')
    ...
    <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
        <div class="hero-container" data-aos="fade-in">
            <h1>Charles Fonzy Varquez</h1>
            <p class="text-center">I'm a <span class="typed"
                    data-typed-items="Web Designer!, Web Developer!, Freelancer!, Programmer!"></span></p>
        </div>
    </section><!-- End Hero -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
                        <form id="editable-form" class="editable-form">
                            <h3><span id="job" data-type="text" data-pk="1" data-title="Enter job">Web Developer</span>.</h3>
                            <p id="job-desc" data-type="text" data-pk="1" data-title="Enter job description" class="fst-italic">
                                ...
                                <div class="col-lg-6">
                                    <ul>
                                        <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span
                                                id="bdate" data-type="text" data-pk="1" data-title="Enter bdate">May 5, 2002</span></li>
                                        <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong>
                                            <span id="website" data-type="text" data-pk="1" data-title="Enter bdate">www.example.com</span>
                                        </li>
                                        <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span id="contact" data-type="text" data-pk="1" data-title="Enter bdate">+63 905 2986 495</span></li>
                                        <li><i class="bi bi-chevron-right"></i> <strong>City:</strong> <span id="city" data-type="text" data-pk="1" data-title="Enter bdate">Malitbog, Southern Leyte</span></li>
                                    </ul>
                                </div>
                                <div class="col-lg-6">
                                    <ul>
                                        <li><i class="bi bi-chevron-right"></i> <strong>Age:</strong> <span>22</span></li>
                                        <li><i class="bi bi-chevron-right"></i> <strong>Degree:</strong> <span id="degree" data-type="text" data-pk="1" data-title="Enter degree">BSIT Graduate</span>
                                        </li>
                                        <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong>
                                            <span id="email" data-type="text" data-pk="1" data-title="Enter email">varquezcharleszy@gmail.com</span>
                                        </li>
                                        <li><i class="bi bi-chevron-right"></i> <strong>Freelance:</strong>
                                            <span id="freelance" data-type="select" data-pk="1" data-title="Select freelance"></span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
